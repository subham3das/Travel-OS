...
interface AdminPaymentHeaderProps {
  searchQuery: string;
...
export const AdminPaymentHeader: React.FC<AdminPaymentHeaderProps> = ({
  searchQuery,
  onSearchChange,
  onToggleFilter,
  isFilterOpen,
      ...
      <div className="flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-xs font-semibold text-slate-500 mt-0.5">
            Monitor every transaction across the Travel OS platform.
          </p>
        </div>
      </div>

      {/* Right Controls: Search, Filter, Export, Export Report */}
