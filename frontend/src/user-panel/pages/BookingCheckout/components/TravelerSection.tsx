...
import { UserCheck, Users, Plus, Trash2, AlertCircle, HeartPulse, FileText, ChevronRight, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <section id="section-traveler" className="space-y-6 scroll-mt-24">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* 2. Additional Travelers / Companions */}
        ...
        {/* 4. Medical Information & Travel Preferences */}
        <div className="bg-white rounded-3xl p-5 sm:p-6 border border-slate-100 shadow-soft space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <textarea
                rows={2}
                placeholder="E.g. Vegetarian meal request, twin bed configuration, airport shuttle time..."
