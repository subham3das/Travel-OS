...
export const CreateRoleModal: React.FC<CreateRoleModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onCreate(name || 'Custom Operator Role', description || 'Custom permissions and access');
    onClose();
  };
        ...
        >
          ...
          <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-black text-[#0F172A]">Create New Role</h3>
                <p className="text-xs text-slate-400 font-semibold">
                  Define custom RBAC access permissions
                </p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                placeholder="e.g. Lead Travel Coordinator"
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                placeholder="Describe role responsibilities and permission scope..."
                rows={3}
                className="w-full px-3.5 py-2.5 rounded-2xl bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#6356E5] focus:bg-white resize-none"
                required
              />
            </div>
