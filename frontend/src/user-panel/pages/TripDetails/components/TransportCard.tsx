...
export const TransportCard: React.FC<TransportCardProps> = ({ trip }) => {
  ...
  return (
    <div
      onClick={() => alert(`Driver: ${transport.driverName}\nVehicle: ${transport.vehicle}\nContact: ${transport.driverPhone}`)}
    ...
    >
      <div className="flex items-center gap-3.5 min-w-0">
        ...
        <div className="space-y-0.5 min-w-0">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Transport Details</h3>
