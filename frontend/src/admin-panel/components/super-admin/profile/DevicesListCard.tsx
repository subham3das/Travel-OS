...
import { Laptop, Smartphone, Monitor, ShieldCheck } from 'lucide-react';
      ...
      <div className="space-y-2">
        {devices.length === 0 ? (
          <div className="py-6 text-center text-slate-400">
            ...
            <p className="text-[11px] font-bold text-slate-500">Current Session Only</p>
            <p className="text-[10px] text-slate-400">No other active devices detected.</p>
          </div>
        ) : (
          devices.map((dev) => (
            <div
