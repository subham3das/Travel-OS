...
export const HeroCarousel: React.FC<HeroCarouselProps> = ({
  ...
  return (
    <div className="relative w-full h-[260px] sm:h-[320px] md:h-[380px] rounded-3xl overflow-hidden shadow-md border border-slate-100/50 group">
          ...
          <div className="absolute inset-0 p-6 sm:p-8 md:p-10 flex flex-col justify-between text-white z-10">
            ...
            <div className="pt-2">
              <motion.button
                ...
                className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full bg-[#FF4D6D] hover:bg-[#e03d5c] text-white font-bold text-xs sm:text-sm shadow-lg shadow-[#FF4D6D]/30 transition-all focus:outline-none"
              >
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-1.5 bg-black/30 backdrop-blur-xs px-3 py-1.5 rounded-full border border-white/20">
