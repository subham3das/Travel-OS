...
import { CheckCircle2, Edit3, Calendar, MapPin, Users } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row items-start gap-4">
        ...
        <div className="flex-1 space-y-2.5 w-full">
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              onClick={() => navigate(`/booking/traveler-details/${pkg.id}`)}
          ...
          <div className="grid grid-cols-1 min-[480px]:grid-cols-3 gap-2.5 pt-1 text-xs font-bold text-slate-600">
            ...
            <div className="flex items-center gap-2 p-2 rounded-2xl bg-slate-50 border border-slate-100">
              ...
              <div>
                <p className="text-xs font-extrabold text-[#0F172A]">Guwahati</p>
                <p className="text-[10px] font-semibold text-slate-400">Pickup Point</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 p-2 rounded-2xl bg-slate-50 border border-slate-100">
              ...
              <div>
                <p className="text-xs font-extrabold text-[#0F172A]">{travelerCount} Travelers</p>
                <p className="text-[10px] font-semibold text-slate-400">1 Adult, 1 Child</p>
              </div>
            </div>
          </div>

          <p className="text-[10px] font-semibold text-slate-400 tracking-wider">
            Package ID: APTRIP-78291
          </p>
        </div>
      </div>
    </div>
