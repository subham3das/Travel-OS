...
export const StickyPaymentBar: React.FC<StickyPaymentBarProps> = ({
  ...
  return (
    <div className="sticky bottom-0 inset-x-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200/90 shadow-2xl py-3 px-4 sm:px-6 flex items-center justify-center select-none pb-safe">
      <div className="w-full max-w-3xl flex items-center justify-between gap-3 sm:gap-6">
        ...
        <div className="flex flex-col justify-center min-w-0">
          ...
          <span className="text-base sm:text-xl font-black text-[#0F172A] tracking-tight block leading-tight">
        ...
        <button
          ...
          disabled={isDisabled}
          onClick={onPayClick}
          className={`h-11 sm:h-13 px-4 sm:px-6 rounded-2xl font-black text-xs sm:text-sm shadow-lg transition-all focus:outline-none flex items-center justify-center gap-2 shrink-0 ${
            isDisabled
