...
interface AdminPackageHeaderProps {
  searchQuery: string;
...
export const AdminPackageHeader: React.FC<AdminPackageHeaderProps> = ({
  searchQuery,
  onSearchChange,
  onToggleFilter,
  isFilterOpen,
      ...
      <div className="flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-xs font-semibold text-slate-500 mt-0.5">
            Manage all travel packages published on the platform.
          </p>
        </div>
      </div>

      {/* Right Controls: Search, Filter, Export, Add Package */}
