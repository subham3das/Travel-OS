                ...
                <>
                  ...
                  <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-2xs space-y-3">
                    ...
                    <div className="space-y-2.5 text-xs font-semibold">
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <span className="text-[10px] font-bold text-slate-400 block">Lead Traveler</span>
                          <span className="font-extrabold text-[#0F172A] block truncate mt-0.5">
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100">
                        <div>
                          ...
                          <span className="font-extrabold text-[#0F172A] block mt-0.5">{booking.travelersSummary}</span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100">
                        <div>
                          ...
                          <span className="font-black text-[#0F172A] text-sm block mt-0.5">{booking.totalAmount}</span>
                        </div>

                        <div>
                          <span className="text-[10px] font-bold text-slate-400 block">Booking Source</span>
                          <span className="font-bold text-slate-700 block mt-0.5">{booking.bookingSource}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <span className="font-extrabold text-[#0F172A] block mt-0.5">{booking.paymentMethod}</span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100">
                        <div>
                          ...
                          <span className="font-black text-[#0F172A] block mt-0.5">{booking.paidAmount}</span>
                        </div>

                        <div>
                          <span className="text-[10px] font-bold text-slate-400 block">Payment Date</span>
                          <span className="font-semibold text-slate-600 text-[10px] block mt-0.5">
                            {booking.paidDate}
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-2xs space-y-2">
                    ...
                    <div className="space-y-1.5 text-xs font-semibold">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-sm font-black text-[#0F172A]">
              ...
              {activeTab === 'Travelers' && (
                <div className="space-y-3">
                  ...
                  {booking.travelers.map((t, idx) => (
                    <div
                      key={t.id || idx}
                      className="bg-white rounded-2xl p-3.5 border border-slate-100 shadow-2xs space-y-2 text-xs"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-full bg-purple-100 text-[#6356E5] flex items-center justify-center font-bold text-xs">
                            {t.name.charAt(0)}
                          </div>
                          <div>
                  ...
                  <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-2xs space-y-2.5 text-xs">
                    ...
                    <div className="pt-2 border-t border-slate-100 space-y-1.5 text-[11px] text-slate-600">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono font-bold text-slate-700">{booking.transactionId}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-slate-700">{booking.paidDate}</span>
                      </div>
                    </div>
                  </div>
                </div>
