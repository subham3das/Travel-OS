...
import { UserKPIStats } from '../../../types/userManagement';
...
export const UserKPISection: React.FC<UserKPISectionProps> = ({
  stats,
  onFilterByStatus,
}) => {
  const cards = [
    {
      ...
      icon: <Users className="w-5 h-5 text-[#6356E5]" />,
    ...
    },
    {
      ...
      growth: stats.newUsersToday.growth,
    ...
    },
    {
      ...
      value: stats.premiumMembers.count.toLocaleString(),
      growth: stats.premiumMembers.growth,
      isPositive: stats.premiumMembers.isPositive,
      comparison: 'from last 30 days',
    ...
    },
    {
      ...
      growth: stats.suspendedUsers.growth,
      isPositive: false,
      comparison: 'from last 30 days',
      icon: <PauseCircle className="w-5 h-5 text-rose-500" />,
      bgColor: 'bg-rose-50',
      filterVal: 'Suspended',
    },
    {
      ...
      value: stats.verifiedTravelers.count.toLocaleString(),
      growth: stats.verifiedTravelers.growth,
      isPositive: stats.verifiedTravelers.isPositive,
      comparison: 'from last 30 days',
