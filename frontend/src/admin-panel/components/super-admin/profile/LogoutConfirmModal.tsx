        ...
        >
          ...
          <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-black text-[#0F172A]">Sign Out</h3>
                <p className="text-xs text-slate-400 font-semibold">End admin session</p>
              </div>
            </div>
          ...
          <div className="p-5 space-y-4 text-xs">
            <p className="text-slate-600 font-medium leading-relaxed">
              Are you sure you want to sign out of the <strong className="text-slate-900">Travel OS Super Admin Panel</strong>?
