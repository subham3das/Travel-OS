...
export const UserGrowthCard: React.FC<UserGrowthCardProps> = ({ metric }) => {
  ...
  return (
    ...
    >
      ...
      {/* SVG Smooth Chart */}
      <div className="mt-4">
        <CustomAreaChart data={metric.dataPoints} color="emerald" yAxisSuffix="K" />
      </div>
      ...
      <div className="mt-3 pt-2.5 border-t border-slate-50 flex items-center justify-between text-[11px] font-bold text-slate-400">
        ...
        <span className="text-emerald-600 font-extrabold cursor-pointer hover:underline">View Users</span>
      </div>
    </motion.div>
  );
};
